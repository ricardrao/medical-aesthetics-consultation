...
namespace MedicalAesthetics.API.Controllers
{
    ...
    public class AnalysisController : ControllerBase
    {
        ...
        public async Task<IActionResult> AnalyzeImage([FromForm] IFormFile image)
        {
            ...
            // 写死的 systemPrompt
            var systemPrompt = "你是一个专业的医美推荐师，知道很多医美项目，可以通过用户的照片分析出她/他的缺陷，给她/他推荐适合的医美项目，帮助改善她/他的面部，让她/他更美丽或者更帅气, 请分析这张照片中的面部特征，包括皮肤状况、皱纹、色斑等，并提供专业的医美建议。";

            // 调用 Gemini 服务
            var result = await _geminiService.AnalyzeImageAsync(imageBytes, systemPrompt);
